...
<div id="content" class="site-content" tabindex="-1">
    ...
    <nav class="woocommerce-breadcrumb">
        <a href="<?= $this->url->get('dashboard') ?>">Dashboard</a>
        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
        <a href="<?= $this->url->get('dashboard/order') ?>">Order History</a>
        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
        <a href="<?= $this->url->get('trackorder') ?>">Track Order</a>
        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
        <a href="<?= $this->url->get('logout') ?>"><strong>Log Out</strong></a>
    </nav>
        <?= $this->getContent() ?>
    </div>
</div>
