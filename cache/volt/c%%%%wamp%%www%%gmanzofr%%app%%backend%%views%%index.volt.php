...
<head>
        ...
        <!--begin::Base Styles -->  
				...
				<link href="<?= $this->url->get('assets/b/demo/default/base/style.bundle.css') ?>" rel="stylesheet" type="text/css" />
		        <!--end::Base Styles -->

        <link rel="shortcut icon" href="<?= $this->url->get('assets/b/demo/default/media/img/logo/favicon.ico') ?>" />
</head>
    <!-- end::Head -->
	...
	<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
		<div class="m-login__container">
			<div class="m-login__logo">
				<a href="#">
				<img src="<?= $this->url->get('assets/b/app/media/img/logos/logo-1.png') ?>">
				</a>
			</div>
...
<!-- end:: Page -->
    	...
    	<!--begin::Base Scripts -->        
		    	...
		    	<script src="<?= $this->url->get('assets/b/demo/default/base/scripts.bundle.js') ?>" type="text/javascript"></script>
				<!--end::Base Scripts -->   
        ...
        <!--begin::Page Snippets --> 
                <script src="<?= $this->url->get('assets/b/snippets/pages/user/login.js') ?>" type="text/javascript"></script>
                <!--end::Page Snippets -->   
