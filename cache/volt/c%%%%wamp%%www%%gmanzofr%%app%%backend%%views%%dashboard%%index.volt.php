	...
	<div class="m-widget1__item">
		<div class="row m-row--no-padding align-items-center">
			<div class="col">
				...
				<span class="m-widget1__desc">Overall Sales Transaction</span>
			</div>
			<div class="col m--align-right">
				<span class="m-widget1__number m--font-brand"><?= $totalSalesRow ?></span>
			</div>
		</div>
	</div>
	<div class="m-widget1__item">
		<div class="row m-row--no-padding align-items-center">
			...
			<div class="col m--align-right">
				<span class="m-widget1__number m--font-danger"><?= $totalOrderRow ?></span>
			</div>
		</div>
	</div>
	<div class="m-widget1__item">
		<div class="row m-row--no-padding align-items-center">
			<div class="col">
				...
				<span class="m-widget1__desc">Products in our Database</span>
			</div>
			<div class="col m--align-right">
				<span class="m-widget1__number m--font-success"><?= $totalProducts ?></span>
			</div>
		</div>
	</div>
</div>
