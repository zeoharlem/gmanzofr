			...
			<form class="m-form m-form--fit m-form--label-align-right" method="POST">
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <?php foreach ($category as $keyCat => $valueCat) { ?>
                            <option value="<?= $valueCat->category_id ?>"><?= ucwords($valueCat->category_name) ?></option>
                        <?php } ?>
                        </select>
                    </div>
                </div>
	    ...
	    <!--end: Datatable --><!--begin: Search Form -->
                    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                <a href="<?= $this->url->get('backend/products') ?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                    <span>
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?= ucwords($values->getCategory()->category_name) ?></td>
                            <td><?= ucwords($values->sub_category_name) ?></td>
                            <td>
                                <div class="btn-group">
