...
class Module implements ModuleDefinitionInterface{
    ...
    public function registerAutoloaders(DiInterface $di = null) {
        ...
        $loader->registerNamespaces(array(
            ...
            'Multiple\Frontend\Recaptcha'   => '../app/frontend/library/',
    ...
    public function registerServices(DiInterface $di) {
        ...
        //var_dump($config->paystack->public); exit;
        //Return API config
    ...
    //    });
        ...
        $smtpConfig     = [
            ...
            'port'      => 465,
            'encryption'=> 'ssl',
            'username'  => 'theophilus.alamu8@gmail.com',
            'password'  => 'biodunWUNMI',
            'from'      => [
                'email' => 'theophilus.alamu8@gmail.com',
                'name'  => 'Theophilus Alamu'
            ]
        ];
        ...
        /**
         * Using SMTP to send mail from localhost
         */
        ...
        //Setting up PayStack
        $di->setShared('paystack', function() use ($config){
        ...
        $di->set('url', function(){
            ...
            $url->setBaseUri('/gmanzofr/');
//            $url->setBaseUri('https://helperscircle.com/users/');
            return $url;
        });
