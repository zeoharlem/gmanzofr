							...
							<div class="body">
								...
								<div class="menu-footer-menu-1-container">
									<ul id="menu-footer-menu-1" class="menu">
                                                                            {% for keyCat, valCat in categories %}
										<li class="menu-item"><a href="{{url('shops/browse?c='~valCat.category_id~'&category='~valCat.category_name~''~activeShop)}}">{{valCat.category_name | capitalize}}</a></li>
                                                                            {% endfor %}
									</ul>
								</div>
							</div>
							...
							<div class="body">
								...
								<div class="menu-footer-menu-3-container">
									<ul id="menu-footer-menu-3" class="menu">
										...
										<li class="menu-item"><a href="{{ url('trackorder') }}">Track your Order</a></li>
			...
			<div class="pull-right flip payment">
				<div class="footer-payment-logo">
					<ul class="cash-card card-inline">
						<li class="card-item"><img src="{{ url('assets/images/footer/payment-icon/1.png') }}" alt="" width="52"></li>
						<li class="card-item"><img src="{{ url('assets/images/footer/payment-icon/2.png') }}" alt="" width="52"></li>
						<li class="card-item"><img src="{{ url('assets/images/footer/payment-icon/3.png') }}" alt="" width="52"></li>
						<li class="card-item"><img src="{{ url('assets/images/footer/payment-icon/4.png') }}" alt="" width="52"></li>
						<li class="card-item"><img src="{{ url('assets/images/footer/payment-icon/5.png') }}" alt="" width="52"></li>
					</ul>
				</div><!-- /.payment-methods -->
			</div>
		</div><!-- /.container -->
