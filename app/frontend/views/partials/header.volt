	...
	<div class="container">
		...
		<nav>
			<ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
				...
				<li class="menu-item animate-dropdown"><a title="Shop" href="{{url('category/')}}"><i class="ec ec-shopping-bag"></i>Categories</a></li>
...
<div class="header-logo">
	<a href="{{url('index')}}" class="header-logo-link">
		<img src="{{ url('assets/images/gmanzo.png') }}" width="70%" />
	</a>
</div>
<!-- ============================================================= Header Logo : End============================================================= -->
    ...
    <div class="collapse navbar-toggleable-xs" id="default-header">
		<nav>
	        <ul id="menu-main-menu" class="nav nav-inline yamm">
	            ...
	            <li class="menu-item animate-dropdown"><a title="About Us" href="{{ url('about/') }}">About Us</a></li>
	            <li class="menu-item animate-dropdown"><a title="Check Categories" href="{{ url('category/') }}">Categories</a></li>
...
<nav class="navbar navbar-primary navbar-full">
    ...
    <li class="nav-item dropdown">
        ...
        <ul id="menu-vertical-menu" class="dropdown-menu yamm departments-menu-dropdown" style="">
            <li class="highlight menu-item animate-dropdown"><a title="Top 100 Offers" href="{{ url('category/') }}">Categories</a></li>
            ...
            <li class="menu-item animate-dropdown"><a title="{{keyVal.category_name | capitalize}}" href="{{url('category/browse?c='~keyVal.category_id~'&category='~keyVal.category_name~''~activeShop)}}">{{keyVal.category_name | capitalize}}</a></li>
            {% endfor %}
        </ul>
    </li>
</ul>
	...
	<div class="input-group">
		...
		<div class="input-group-addon search-categories">
			<select name="product_cat" id="product_cat" class="postform resizeselect" style="width: 443px;">
                ...
                {% for keyCat, keyVal in categories %}
                    <option class="level-0" value="{{ keyVal.category_id }}">{{keyVal.category_name | capitalize}}</option>
                {% endfor %}
			</select>
		</div>
