...
{{ partial("partials/header_below") }}
    ...
    <header>
            <h2 class="h1"><strong>{{ name }}</strong></h2>
    </header>
            ...
            {% for keyPro, varPro in productList %}
                ...
                <div class="product-outer">
                    <div class="product-inner">
                        <span class="loop-product-categories"><a href="javascript:void(0)" rel="tag">{{varPro['category'] | capitalize}} | {{varPro['location'] | capitalize}}</a></span>
