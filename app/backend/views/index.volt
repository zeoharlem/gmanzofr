...
<head>
        ...
        <!--begin::Base Styles -->  
				...
				<link href="{{ url('assets/b/demo/default/base/style.bundle.css') }}" rel="stylesheet" type="text/css" />
		        <!--end::Base Styles -->

        <link rel="shortcut icon" href="{{ url('assets/b/demo/default/media/img/logo/favicon.ico') }}" />
</head>
    <!-- end::Head -->
...
<div class="m-grid m-grid--hor m-grid--root m-page">
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url(assets/b/app/media/img/bg/bg-2.jpg);">
	<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
		<div class="m-login__container">
			<div class="m-login__logo">
				<a href="#">
				<img src="{{ url('assets/b/app/media/img/logos/logo-1.png') }}">
				</a>
			</div>
...
<!-- end:: Page -->
    	...
    	<!--begin::Base Scripts -->        
		    	...
		    	<script src="{{ url('assets/b/demo/default/base/scripts.bundle.js') }}" type="text/javascript"></script>
				<!--end::Base Scripts -->   
        ...
        <!--begin::Page Snippets --> 
                <script src="{{ url('assets/b/snippets/pages/user/login.js') }}" type="text/javascript"></script>
                <!--end::Page Snippets -->   
